...
public class GameRepositoryTest {
	...
	public void findById_Found() {
		...
		Assert.assertEquals("", game.getGameTeams().get(0).getEventTeam().getOrganizationTeam().getCity());
		Assert.assertEquals("", game.getGameTeams().get(0).getEventTeam().getOrganizationTeam().getState());
		Assert.assertEquals("", game.getGameTeams().get(0).getEventTeam().getOrganizationTeam().getZipCode());
		Assert.assertEquals("", game.getGameTeams().get(0).getEventTeam().getOrganizationTeam().getCountry());
		...
		Assert.assertEquals("", game.getGameRound().getGameLocation().getOrganizationLocation().getAddress1());
		Assert.assertEquals("", game.getGameRound().getGameLocation().getOrganizationLocation().getAddress2());
		Assert.assertEquals("", game.getGameRound().getGameLocation().getOrganizationLocation().getCity());
		Assert.assertEquals("", game.getGameRound().getGameLocation().getOrganizationLocation().getState());
		Assert.assertEquals("", game.getGameRound().getGameLocation().getOrganizationLocation().getZipCode());
		Assert.assertEquals("", game.getGameRound().getGameLocation().getOrganizationLocation().getCountry());
